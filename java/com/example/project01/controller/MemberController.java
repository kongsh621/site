...
public class MemberController {
    ...
    @PostMapping("/login")
    public String loginSuccess(@SessionAttribute(name = "loginMember", required = false) MemberVO loginMember,
    ...
    public String kakaoCallback(String code, HttpServletRequest request, Model model, RedirectAttributes ra, Criteria criteria){
        ...
        try {
            ...
            MemberVO user = memberService.selectMember(kakaoUser);
    ...
    public String update(@SessionAttribute(name = "loginMember", required = false) MemberVO loginMember, Model model,
                         @ModelAttribute MemberVO member, RedirectAttributes ra, HttpSession session,
                         Criteria criteria) {
        model.addAttribute("loginSession", loginMember);
    ...
    public String passFindCheck(@SessionAttribute(name = "loginMember", required = false) MemberVO loginMember,
                                @ModelAttribute MemberVO memberVO, Model model, RedirectAttributes ra,
