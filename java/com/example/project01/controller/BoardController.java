...
public class BoardController {
    ...
    public String list(Model model, Criteria criteria, @SessionAttribute(name = "loginMember", required = false) MemberDTO loginMember,
        ...
        List<BoardDTO> result = boardService.getListWithPaging(criteria);
    ...
    @PostMapping("/write")
    public String write(BoardDTO board, RedirectAttributes redirectAttributes, Model model, MultipartFile file,
    ...
    @GetMapping("/write")
    public String write(@SessionAttribute(name = "loginMember", required = false) MemberDTO loginMember, Model model,
    ...
    public String read(@RequestParam Long id, Criteria criteria, Model model, HttpServletRequest request,
        ...
        try {
            ...
            BoardDTO boardResult = boardService.get(id);
            ...
            // 댓글 불러와서 list로 보냄
            List<BoardCommentDTO> list = boardService.getCommentWithPaging(map);
    ...
    @PostMapping("/update")
    public String update(BoardDTO board, Criteria criteria, RedirectAttributes ra,
                         @SessionAttribute(name = "loginMember", required = false) MemberDTO loginMember, Model model) {
    ...
    public String delete(@RequestParam("id") Long id, Criteria criteria, RedirectAttributes ra,
        ...
        BoardDTO file = boardService.findFiles(id);
    ...
    public String deleteComment(@ModelAttribute BoardCommentDTO commentVO,
