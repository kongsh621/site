            ...
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="../infoboard/?page=${pageMaker.criteria.page-1}" aria-label="Previous">
                    ...
                    <c:forEach var="i" begin="1" end="${pageMaker.lastPage}">
                        <li class="page-item ${i == pageMaker.criteria.page ? 'active' : ''}">
                            <a class="page-link" href="../infoboard/?page=${i}">${i}</a>
                        </li>
                    </c:forEach>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="../infoboard/?page=${pageMaker.criteria.page+1}" aria-label="Next">
